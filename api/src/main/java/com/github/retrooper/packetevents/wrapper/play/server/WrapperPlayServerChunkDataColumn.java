...
public class WrapperPlayServerChunkDataColumn<T extends WrapperPlayServerChunkDataColumn<T>> extends PacketWrapper<T> {
    ...
    public WrapperPlayServerChunkDataColumn(Column column) {
        this(column, false);
    }

    public WrapperPlayServerChunkDataColumn(Column column, boolean ignoreOldData) {
